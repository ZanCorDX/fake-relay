...
// Copy from mev-boost-relay/common/types_spec.go with the exception of the error ErrEmptyPayload which was added to allow compiling without adding more files
